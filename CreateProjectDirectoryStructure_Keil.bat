...
IF EXIST Source\FreeRTOS_Source Goto END
	...
	MD Source\FreeRTOS_Source\portable\RVDS
	MD Source\FreeRTOS_Source\portable\RVDS\ARM_CM0
	...
	copy ..\..\Source\portable\RVDS\ARM_CM0\*.* Source\FreeRTOS_Source\portable\RVDS\ARM_CM0
	
	REM Copy the basic memory allocation files
	copy ..\..\Source\portable\MemMang\heap_4.c Source\FreeRTOS_Source\portable\MemMang
